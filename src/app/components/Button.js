...
const Button = ({ text, action }) => {
  return (
    <a
      href=''
      className='group relative px-4 py-2 md:px-8 md:py-3 text-mobile-body bg-secondary/80  '>
      <span className='absolute inset-0 border border-dashed border-gray-900 '></span>
      {text}
      <svg
