    ...
    <div className='w-full overflow-hidden relative fade-mask-x'>
      ...
      <div
        ...
        {loopedBrands.map((src, index) => (
          <div
            key={index}
            className={`flex items-center justify-center mx-8 w-[150px] md:w-[200px] h-[100px] grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300`}>
            <img
              src={src}
              alt={`Brand ${index}`}
