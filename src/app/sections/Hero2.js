...
const Hero2 = () => {
  ...
  const slides = [
    '/images/carouselImages/Exteriorfrente.png',
    '/images/carouselImages/ProyectoAA2000.png',
    '/images/carouselImages/Living2.png',
    '/images/carouselImages/CocinaComedor.png',
  ]
  ...
  return (
    <section className='min-h-screen'>
        ...
        <div className='layout-grid'>
          ...
          <div className='col-span-full md:col-start-2 md:col-span-10 flex flex-col gap-6 md:gap-8 mt-24'>
            <h1 className='text-mobile-title sm:text-tablet-title lg:text-web-title font-bold text-primary tracking-tighter leading-none'>
              <WaveText
                text='Redefinimos la experiencia '
                className=''
                delay={0}
                noWrap={true}
              />
              <WaveText
                text='de la construcción.'
      ...
      <div
        ...
        ref={emblaRef}>
        <div className='flex ml-0 md:-ml-[24px]'>
          {slides.map((src, index) => (
            <div
              key={index}
              className='flex-[0_0_100%] md:flex-[0_0_83.33%] min-w-0 relative h-[50vh] md:h-[80vh] pl-0 md:pl-[24px] gap-16'>
              ...
              <Image
                ...
                className={` px-4 md:px-16 w-full h-full object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-500 ${
