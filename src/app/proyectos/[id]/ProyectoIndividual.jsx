...
import { cld } from '@/app/utils/cloudinary'
      ...
      <section
        ...
        <div className='relative h-screen w-full flex items-end'>
          <Image
            ...
            fill
            src={cld(proyecto.images?.[0], { w: 2200, crop: 'fill' })}
          ...
          <div className='w-full py-8 md:py-16 fade-in'>
            <div className='relative w-full h-[50vh] md:h-[70vh]'>
              <Image
                ...
                fill
                src={cld(proyecto.images[1], { w: 2200, crop: 'fill' })}
                className='object-cover'
                sizes='100vw'
                unoptimized
              />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 fade-in'>
              <div className='relative h-[40vh] md:h-[60vh]'>
                <Image
                  alt='Imagen del proyecto'
                  fill
                  src={cld(proyecto.images[2], { w: 1600, crop: 'fill' })}
                  className='object-cover'
              ...
              <div className='relative h-[40vh] md:h-[60vh]'>
                <Image
                  alt='Imagen del proyecto'
                  fill
                  src={cld(proyecto.images[3], { w: 1600, crop: 'fill' })}
                  className='object-cover'
                  sizes='(min-width: 768px) 50vw, 100vw'
                  unoptimized
                />
              ...
              <div className='col-span-4 md:col-span-7 fade-in'>
                <div className='relative h-[50vh] md:h-[70vh]'>
                  <Image
                    alt='Imagen del proyecto'
                    fill
                    src={cld(proyecto.images[4], { w: 2000, crop: 'fill' })}
                    className='object-cover'
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 fade-in'>
              <div className='md:col-span-2 relative h-[45vh] md:h-[65vh]'>
                <Image
                  alt='Imagen del proyecto'
                  fill
                  src={cld(proyecto.images[5], { w: 2200, crop: 'fill' })}
                  className='object-cover'
              ...
              <div className='md:col-span-1 relative h-[45vh] md:h-[65vh]'>
                <Image
                  alt='Imagen del proyecto'
                  fill
                  src={cld(proyecto.images[6], { w: 1400, crop: 'fill' })}
                  className='object-cover'
            ...
            <div className='layout-wrap'>
              <div className='relative w-full h-[50vh] md:h-[70vh]'>
                <Image
                  ...
                  fill
                  src={cld(image, { w: 2200, crop: 'fill' })}
                  className='object-cover'
                  sizes='100vw'
                  unoptimized
                />
